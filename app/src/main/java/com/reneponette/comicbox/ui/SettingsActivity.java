...
//		pref = getPreferenceScreen().findPreference("explorer_num_of_column");
		...
		fakeHeader = new PreferenceCategory(this);		
		fakeHeader.setTitle(R.string.pref_header_accounts);
		getPreferenceScreen().addPreference(fakeHeader);
		addPreferencesFromResource(R.xml.pref_accounts);
		pref = getPreferenceScreen().findPreference("accounts_dropbox_logout");
...
//		bindPreferenceSummaryToValue(findPreference("viewer_use_volume_key"));
	}
